...
// fun things to tweak
final int     squiggle_total = 5;  //400   // Total times to pick up the pen
final int     squiggle_length = 200; //600   // Too small will fry your servo
final int     half_radius = 100;       //3   // How grundgy
final int     adjustbrightness = 100;  //8   // How fast it moves from dark to light, over draw
final float   sharpie_dry_out = 200;   // Simulate the death of sharpie, zero for super sharpie
String        nameFile="14";
